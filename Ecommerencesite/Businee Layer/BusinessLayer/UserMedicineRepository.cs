          ...
          public class UserMedicineRepository : IUserMedicineRepository
          {
                    ...
                    public ResponseModel CREATERegisterUser(UserMedicine userregistMedicine)
                    {
                              ...
                              try
                              {
                                        ...
                                        _context.userMedicines.Add(userregistMedicine);
                    ...
                    {
                              var user = _context.userMedicines.Find(userdeleteMedicine.id);
                              if (user != null)
                              {
                                        _context.userMedicines.Remove(user);
                                        _context.SaveChanges();
                                        return new ResponseModel
                                        {
                                                  status = true,
                    ...
                    {
                              var orders = _context.userMedicines.ToList();
                              return new ResponseModel
                              {
                                        status = true,
                    ...
                    {
                              var order = _context.userMedicines.Add(userOrder);
                              _context.SaveChanges();
                              return new ResponseModel
                              {
                                        status = true,
                    ...
                    {
                              var response = _context.userMedicines.Update(userUpdateMedicine);
                              _context.SaveChanges();
                              return new ResponseModel
                              {
                                        status = true,
                    ...
                    {
                              var users = _context.userMedicines.ToList();
                              return new ResponseModel
                              {
                                        status = true,
                    ...
                    {
                              var user = _context.userMedicines.Where(s => s.id == id).FirstOrDefault();
                              if (user != null)
                              {
                                        return new ResponseModel
                                        {
